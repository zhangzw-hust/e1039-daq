...
void vme_tir_latch_tdc__init (rolp)
     rolParam rolp;
{
...
| (( 0x01 ) << 8) | (0xff & *(rol->nevents));	}	((rol->dabufp))++;} ;  latchFifoStatus(0,3);
  *rol->dabufp++ = vxTicks;
