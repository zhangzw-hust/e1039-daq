...
extern int evOpen(char *filename, char *flags, long *handle);
extern int evRead(long handle, int *buffer, int buflen);
extern int evGetNewBuffer(EVFILE *a);
extern int evWrite(long handle,int *buffer);
extern int evFlush(EVFILE *a);
extern int evIoctl(long handle,char *request,void *argp);
extern int evClose(long handle);
extern int evOpenSearch(long handle, long *b_handle);
extern int evSearch(long handle, long b_handle, int evn, int *buffer, int buflen, int *size);
extern int evCloseSearch(long b_handle);
