...
#ld</usr/local/coda/2.6.1/extensions/scale32/scale32Lib.o
...
#
taskSpawn ("TS",200,8,250000,coda_roc,"-i","-s","Spin","-objects","TSe906 TS")
#taskSpawn ("TS",200,8,250000,coda_roc,"-i","-s","Sea2","-objects","TSe906 TS")
