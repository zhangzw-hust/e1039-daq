...
mRouteAdd("224.0.0.0","192.168.24.25",0xf0000000,0,0)
...
#load trigger interface test code.
#ld < /data2/e906daq/coda/2.6/extensions/ts_test/vme_link_ts5.o
...
taskSpawn ("ROC",200,8,250000,coda_roc,"-i","-s","Sea2","-objects","ROC5 ROC")
