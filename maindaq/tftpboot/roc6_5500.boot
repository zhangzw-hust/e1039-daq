...
mRouteAdd("224.0.0.0","192.168.24.242",0xf0000000,0,0)
...
hostAdd "e906daq4.fnal.gov","192.168.24.8"

# Setup environment to load coda_roc
putenv "MSQL_TCP_HOST=e906daq4.fnal.gov"
...
taskSpawn ("ROC",200,8,250000,coda_roc,"-i","-s","Sea2","-objects","ROC6 ROC")
