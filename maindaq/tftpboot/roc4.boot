...
mRouteAdd("224.0.0.0","192.168.24.24",0xf0000000,0,0)
...
ld< /usr/local/coda/2.6.1/extensions/e906/v1495Pulser.o
...
taskSpawn ("ROC",200,8,250000,coda_roc,"-i","-s","Sea2","-objects","ROC4 ROC")
