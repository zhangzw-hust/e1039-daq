...
mRouteAdd("224.0.0.0","192.168.24.31",0xf0000000,0,0)
...
#latchInit(0x09100000,0x100000,4);
#tdcInit(0x431000,0x01000,6);
...
taskSpawn ("ROC",200,8,250000,coda_roc,"-i","-s","Sea2","-objects","ROC11 ROC")
